---
title: "Thresholded classtpx on sorted + unsorted PBMC data"
author: "Kushal K Dey"
date: "8/29/2017"
...
```{r}
data2 <- seuratObj_TFH_global@raw.data[indices_vec, ]
```

```{r echo=FALSE, eval=TRUE}
fac1 <- sapply(colnames(data2)[1:4500], function(x) return(paste0(head(strsplit(x, "[_]")[[1]], -1), collapse="_")))
...
topic_clus <- classtpx::class_topics(counts, K=9, known_samples = known_samples, class_labs = class_labs, method = "theta.fix", shrink = FALSE, tol = 0.00001)
save(topic_clus, file = "../output/classtpx_pbmc_68K_thresh.rda")
```

## CountClust Structure

```{r echo=FALSE, eval=TRUE}
topic_clus <- get(load("../output/classtpx_pbmc_68K_thresh.rda"))
```
