---
title: "Cluster analysis of the PBMC Oct 16 GRN760"
author: "Kushal K Dey"
date: "8/4/2017"
output: html_document
---

We look at the cluster patterns of the PBMC cluster data for Oct 2016 (GRN760).
...
counts6 <- get(load("../output/GS_PBMC_10_2016_GRN0760.rda"))
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_GRN760.rda")
```

```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_GRN760.rda"))
fac <- rep("PBMC-10-2016", dim(counts6)[1])
```
...
```{r}
topic_clus <- get(load("../output/maptpx_GS_PBMC_10_2016_GRN0760.rda"))
```
