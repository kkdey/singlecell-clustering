---
title: "Cluster analysis of the PBMC  Feb 16 GRN535"
author: "Kushal K Dey"
date: "8/4/2017"
output: html_document
---

We look at the cluster patterns of the PBMC cluster data for Feb 2016 (GRN535).
...
counts6 <- get(load("../output/GS_PBMC_2_2016_GRN0535.rda"))
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_GRN535.rda")
```

```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_GRN535.rda"))
fac <- rep("PBMC-2-2016", dim(counts6)[1])
```
