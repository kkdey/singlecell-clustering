---
title: "Cluster analysis of the PBMC  Feb, 2015 GRN304"
author: "Kushal K Dey"
date: "8/4/2017"
output: html_document
---

We look at the cluster patterns of the PBMC cluster data for Feb 2015 (GRN304).
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_GRN304.rda")
```

```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_GRN304.rda"))
