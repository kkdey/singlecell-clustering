...
```{r echo=FALSE, eval=FALSE}
topic_clus <- classtpx::class_topics(pooled_data, K=12, class_labs = class_labs_2, known_samples = 1:4500, method = "theta.fix", shrink = FALSE, tol = 100, ord=FALSE)
save(topic_clus, file = "../output/classtpx_sorted_MCC_12.rda")
```
...
data_ggplot <- data.frame(labels2 = labels2[-(1:4500)],
                          tSNE_1 = seuratObj_TFH_global@dr$tsne@cell.embeddings[, 1],
                          tSNE_2 = seuratObj_TFH_global@dr$tsne@cell.embeddings[, 2])
