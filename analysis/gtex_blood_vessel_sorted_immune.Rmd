...
save(topic_clus, file = "../output/classtpx_gtex_blood_vessel_sorted_immune.rda")
```

## Cluster representation

```{r}
topic_clus <- get(load("../output/classtpx_gtex_blood_vessel_sorted_immune.rda"))
```
...
```{r}
topic_clus <- classtpx::class_topics(pooled_data, K=11, known_samples = known_samples, class_labs = class_labs_2, method = "theta.fix", shrink = FALSE, tol = 1000)
save(topic_clus, file = "../output/classtpx_gtex_blood_vessel_sorted_immune_2.rda")
```
