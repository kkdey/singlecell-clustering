---
title: 'Classification Grade of Membership model on PBMC data: K=11'
author: "Kushal K Dey"
date: "8/28/2017"
...
topic_clus <- classtpx::class_topics(counts, K=11, known_samples = known_samples, class_labs = class_labs, method = "theta.fix", shrink = FALSE, tol = 5)
save(topic_clus, file = "../output/classtpx_pbmc_68K_no_thresh_unsup_2.rda")
```
...
```{r echo=FALSE, eval=TRUE}
topic_clus <- get(load("../output/classtpx_pbmc_68K_no_thresh_unsup_2.rda"))
```
