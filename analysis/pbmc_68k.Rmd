---
title: "Cluster analysis of the subsampled 68K PBMC data"
author: "Kushal K Dey"
date: "8/23/2017"
...
```{r}
fac <- rep("PBMC", dim(topic_clus[[5]]$omega)[1])
...
seuratObj_TFH_global <- get(load("../output/pbmc_68k_after_tsne.rda"))
```
...
labels6 <- as.factor(apply(topic_clus[[9]]$omega, 1, function(x) return(which.max(x))))
