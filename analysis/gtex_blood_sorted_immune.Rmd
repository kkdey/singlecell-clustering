...
save(topic_clus, file = "../output/classtpx_gtex_blood_sorted_immune.rda")
```
...
save(topic_clus, file = "../output/classtpx_gtex_blood_sorted_immune_2.rda")
```

## Cluster representation

```{r}
topic_clus <- get(load("../output/classtpx_gtex_blood_sorted_immune.rda"))
```
...
```{r}
topic_clus_2 <- get(load("../output/classtpx_gtex_blood_sorted_immune_2.rda"))
```
