...
```{r}
topic_clus <- get(load("../output/classtpx_pbmc_68K_training_testing_2.rda"))
```
...
```{r}
topic_clus <- get(load("../output/classtpx_pbmc_68K_training_testing.rda"))
```
...
```{r}
topic_clus <- get(load("../output/classtpx_pbmc_68K_training_testing_3.rda"))
```
