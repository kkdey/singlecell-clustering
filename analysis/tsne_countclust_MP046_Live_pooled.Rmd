---
title: "Pantaleo exploratory analysis - MP046 Live Cells"
author: "Kushal K Dey"
date: "8/8/2017"
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_Live_MP046_pooled.rda")
```

```{r echo=FALSE, eval=FALSE}
save(LiveCells_fac, file = "../output/fac_Live_MP046_pooled.rda")
```


```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_Live_MP046_pooled.rda"))
fac <- get(load("../output/fac_Live_MP046_pooled.rda"))
```
...
```{r}
topic_clus <- get(load("../data/MP046/CountClust_Models_filtered_Live.rda"))
```
