...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_Live_TFH041_pooled.rda")
```

```{r echo=FALSE, eval=FALSE}
save(LiveCells_fac, file = "../output/fac_Live_TFH041_pooled.rda")
```


```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_Live_TFH041_pooled.rda"))
fac <- get(load("../output/fac_Live_TFH041_pooled.rda"))
```
...
```{r}
topic_clus <- get(load("../data/TFH041/CountClust_Models_filtered_Live.rda"))
```
...
match(genes, rownames(seuratObj_TFH_global@data))

genes <- genes[!is.na(match(genes, rownames(seuratObj_TFH_global@data)))]
