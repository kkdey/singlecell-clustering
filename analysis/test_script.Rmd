...
author: "Kushal Dey, Valentin Voillet"
date: "7/17/2017"
output:
...
LiveCells_LN_UMI <- read.table('TFH146/live cells/LN/reads.TFH_146_LN_S1_R1_001.fastq_bq10_star_corrected.umi.dge.txt', header = TRUE, row.names = 1)
LiveCells_LN_UMI_summary <- read.table('TFH146/live cells/LN/reads.TFH_146_LN_S1_R1_001.fastq_bq10_star_corrected.umi.dge.summary.txt', header = TRUE, row.names = 1)
...
LiveCells_PBMC_UMI <- read.table('TFH146/live cells/PBMC/reads.TFH_146_Blood_S2_R1_001.fastq_bq10_star_corrected.umi.dge.txt', header = TRUE, row.names = 1)
LiveCells_PBMC_UMI_summary <- read.table('TFH146/live cells/PBMC/reads.TFH_146_Blood_S2_R1_001.fastq_bq10_star_corrected.umi.dge.summary.txt', header = TRUE, row.names = 1)
#- First filtering - remove cells with less than 10 genes
...
```{r}
TFH_LN_UMI <- read.table('TFH146/TFH Sorted/LN/reads.TFH146_TFH_LN_S1_R1_001.fastq_bq10_star_corrected.umi.dge.txt.gz', header = TRUE, row.names = 1)
TFH_LN_reads <- read.table('TFH146/TFH Sorted/LN/reads.TFH146_TFH_LN_S1_R1_001.fastq_bq10_star_corrected.reads.dge.txt.gz', header = TRUE, row.names = 1)
TFH_LN_UMI_summary <- read.table('TFH146/TFH Sorted/LN/reads.TFH146_TFH_LN_S1_R1_001.fastq_bq10_star_corrected.umi.dge.summary.txt', header = TRUE, row.names = 1)
TFH_LN_reads_summary <- read.table('TFH146/TFH Sorted/LN/reads.TFH146_TFH_LN_S1_R1_001.fastq_bq10_star_corrected.reads.dge.summary.txt', header = TRUE, row.names = 1)
#- First filtering - remove cells with less than 10 genes
...
##- PBMC
TFH_PBMC_UMI <- read.table('TFH146/TFH Sorted/PBMC/reads.TFH146_TFH_PBMC_S2_R1_001.fastq_bq10_star_corrected.umi.dge.txt.gz', header = TRUE, row.names = 1)
TFH_PBMC_reads <- read.table('TFH146/TFH Sorted/PBMC/reads.TFH146_TFH_PBMC_S2_R1_001.fastq_bq10_star_corrected.reads.dge.txt.gz', header = TRUE, row.names = 1)
TFH_PBMC_UMI_summary <- read.table('TFH146/TFH Sorted/PBMC/reads.TFH146_TFH_PBMC_S2_R1_001.fastq_bq10_star_corrected.umi.dge.summary.txt', header = TRUE, row.names = 1)
TFH_PBMC_reads_summary <- read.table('TFH146/TFH Sorted/PBMC/reads.TFH146_TFH_PBMC_S2_R1_001.fastq_bq10_star_corrected.reads.dge.summary.txt', header = TRUE, row.names = 1)
#- First filtering - remove cells with less than 10 genes
...
save(topic_clus_list, file = "TFH146/CountClust_Models_filtered.rda")
```
...
topic_clus_list <- get(load("TFH146/CountClust_Models_filtered.rda"))
...
PlotCountClust(topic_clus_list[[7]],  LiveCells_fac)
PlotCountClust(topic_clus_list[[8]],  LiveCells_fac)
```
...
for(m in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,m], file = paste0("gene_names_", m, ".txt"), quote = FALSE, row.names = FALSE, col.names = FALSE)
}
```
...
save(topic_clus_list, file = "TFH146/CountClust_Models_filtered_TFH.rda")
```

```{r echo=TRUE, eval=TRUE}
topic_clus_list <- get(load("TFH146/CountClust_Models_filtered_TFH.rda"))
...
PlotCountClust(topic_clus_list[[7]], TFH_fac)
PlotCountClust(topic_clus_list[[8]], TFH_fac)
```
...
save(topic_clus_list, file = "TFH146/CountClust_Models_filtered_pooled.rda")
```
...
```{r}
topic_clus_list <- get(load("TFH146/CountClust_Models_filtered_pooled.rda"))
...
for(m in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,m], file = paste0("gene_names_", m, "_pooled.txt"), quote = FALSE, row.names = FALSE, col.names = FALSE)
}
```
