---
title: 'Gene Set Enrichment Analysis : GRN304 MCC data'
author: "Kushal K Dey"
date: "8/10/2017"
...
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/GRN304/cluster_2/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
l <- 1
pathway2 <- read.delim(paste0("../utilities/GRN304/cluster_2/gene_names_clus_", l, ".tab"))
...
```{r echo=FALSE, eval=TRUE}
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/GRN304/cluster_3/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
l <- 1
pathway2 <- read.delim(paste0("../utilities/GRN304/cluster_3/gene_names_clus_", l, ".tab"))
head(pathway2$pathway, 10)
...
```{r echo=FALSE, eval=TRUE}
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/GRN304/cluster_6/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
l <- 1
pathway2 <- read.delim(paste0("../utilities/GRN304/cluster_6/gene_names_clus_", l, ".tab"))
head(pathway2$pathway, 10)
