---
title: 'Gene Set Enrichment Analysis : aggregated MCC'
author: "Kushal K Dey"
date: "8/10/2017"
...
seuratObj_TFH_global <- get(load("../output/seurat_aggregated_mcc.rda"))
```
...
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/aggregated_data/cluster_2/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
l <- 1
pathway2 <- read.delim(paste0("../utilities/aggregated_data/cluster_2/gene_names_clus_", l, ".tab"))
...
```{r echo=FALSE, eval=TRUE}
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/aggregated_data/cluster_3/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
for(l in 1:dim(imp_genes)[2]){
  write.table(imp_genes[,l], quote = FALSE, file = paste0("../utilities/aggregated_data/cluster_6/gene_names_clus_", l, ".txt"), row.names = FALSE, col.names = FALSE)
}
```
...
```{r echo=FALSE, eval=TRUE}
l <- 1
pathway2 <- read.delim(paste0("../utilities/aggregated_data/cluster_6/gene_names_clus_", l, ".tab"))
head(pathway2$pathway, 10)
