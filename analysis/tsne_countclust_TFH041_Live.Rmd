...
seuratObj_TFH_global <- get(load("../output/TFH041/seuratLiveCells.rda"))
```
...
```{r echo=FALSE, eval=TRUE}
topic_clus <- get(load("../output/TFH041/LN_Live/model2.rda"))
```
...
```{r}
topic_clus <- get(load("../output/TFH041/PBMC_Live/model2.rda"))
```
