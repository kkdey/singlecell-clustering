---
title: "Separate CountClust LN and PBMC for Live cells (TF041)"
author: "Kushal K Dey"
date: "7/27/2017"
...
save(topic_clus_list, file = "../output/TFH041/LN_Live/model2.rda")
```
...
```{r}
topic_clus_list <- get(load("../output/TFH041/LN_Live/model2.rda"))
...
save(topic_clus_list, file = "../output/TFH041/PBMC_Live/model2.rda")
```


```{r}
topic_clus_list <- get(load("../output/TFH041/PBMC_Live/model2.rda"))
