---
title: "Pantaleo exploratory analysis - TFH146 TF sorted cells"
author: "Kushal K Dey"
date: "8/8/2017"
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_TFH_TFH146_pooled.rda")
```

```{r echo=FALSE, eval=FALSE}
save(TFH_fac, file = "../output/fac_TFH_TFH146_pooled.rda")
```


```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_TFH_TFH146_pooled.rda"))
fac <- get(load("../output/fac_TFH_TFH146_pooled.rda"))
```
