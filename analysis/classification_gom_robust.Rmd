---
title: 'Classification Grade of Membership model PBMC: K=9, robust'
author: "Kushal K Dey"
date: "9/1/2017"
...
topic_clus <- classtpx::class_topics(counts, K=9, known_samples = known_samples, class_labs = class_labs, method = "theta.fix", shrink = FALSE, tol = 0.001, ord=FALSE, trim = 0.01)
save(topic_clus, file = "../output/classtpx_pbmc_68K_no_thresh_robust.rda")
```
