---
title: "Pantaleo exploratory analysis - TFH041 TF sorted cells"
author: "Kushal K Dey"
date: "8/8/2017"
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_TFH_TFH041_pooled.rda")
```

```{r echo=FALSE, eval=FALSE}
save(TFH_fac, file = "../output/fac_TFH_TFH041_pooled.rda")
```


```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_TFH_TFH041_pooled.rda"))
fac <- get(load("../output/fac_TFH_TFH041_pooled.rda"))
```
...
```{r}
topic_clus <- get(load("../data/TFH041/CountClust_Models_filtered_TFH.rda"))
```
...
plot13 <- ggplot(data_ggplot) + theme(panel.background = element_rect(colour = "black", size = 1), 
                                     ...
                                     axis.text.x = element_blank(),
                                     axis.ticks = element_blank(),
                                     legend.text = element_text(size = 15)) + geom_point(aes(x = tSNE_1, y = tSNE_2, color = Thirteenth), size = cex.size) + labs(x = 'tSNE 1', y = 'tSNE 2', title = '') + scale_colour_gradient2(low = 'royalblue', high = 'red', mid = 'grey80', midpoint = quantile(seuratObj_TFH_global@data[paste0(genes[12]), ], 0.2),  name = paste0(genes[13]))
