---
title: "Cluster analysis of the PBMC Oct 2013 MCC1050"
author: "Kushal K Dey"
date: "8/4/2017"
output: html_document
---

We look at the cluster patterns of the PBMC cluster data for Oct 2013 (MCC1050).
...
counts6 <- get(load("../output/GS_PBMC_8_2013_MCCB1050.rda"))
counts6 <- as.matrix(counts6)
```

```{r echo=FALSE, eval=FALSE}
seuratObj <- new('seurat', raw.data = t(counts6))
...
```{r echo=FALSE, eval=FALSE}
save(seuratObj_TFH_global, file = "../output/seurat_MCCB1050.rda")
```

```{r echo=FALSE, eval=TRUE}
seuratObj_TFH_global <- get(load("../output/seurat_MCCB1050.rda"))
fac <- rep("PBMC-8-2013", dim(counts6)[1])
```
...
We now plot the expression patterns of top driving genes for the two clusters for $K=2$.
