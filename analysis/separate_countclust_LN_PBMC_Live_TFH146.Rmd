---
title: "Separate CountClust on PBMC and LN cells for Live cells (TFH146)"
author: "Kushal K Dey"
date: "7/27/2017"
...
save(topic_clus_list, file = "../output/TFH146/LN_Live/model2.rda")
```
...
```{r}
topic_clus_list <- get(load("../output/TFH146/LN_Live/model2.rda"))
...
save(topic_clus_list, file = "../output/TFH146/PBMC_Live/model2.rda")
```


```{r}
topic_clus_list <- get(load("../output/TFH146/PBMC_Live/model2.rda"))
